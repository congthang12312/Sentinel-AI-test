...
## Arguments
- Default: Scout using built-in Explore parallel tasks in parallel (`./references/internal-scouting.md`)
...
- Determine optimal SCALE value of parallel tasks to spawn
...
- **Internal (Default):** `references/internal-scouting.md` (Explore parallel tasks)
- **External:** `references/external-scouting.md` (Gemini/OpenCode)

**Notes:**
- Prompt detailed instructions for each skill with exact directories or files it should read
- Remember that each skill has less than 200K tokens of context window
- Amount of parallel tasks to-be-spawned depends on the current system resources available and amount of files to be scanned
- Each skill must return a detailed summary report to a main agent
...
- `references/internal-scouting.md` - Using Explore parallel tasks
