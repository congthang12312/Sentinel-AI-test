...
4. **Isolation prevents degradation** - Partition work across skills
5. **Measure before optimizing** - Know your baseline

**IMPORTANT:**
- Sacrifice grammar for the sake of concision.
- Ensure token efficiency while maintaining high quality.
- Pass these rules to parallel tasks.
...
4. **Isolate**: Split across skills (partitioning)
...
3. Use skills for context isolation, not role-play
