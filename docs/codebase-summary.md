...
**Repository**: [antigravity-kit/antigravity-kit](https://github.com/antigravity-kit/antigravity-kit)

## Overview

Antigravity Kit is a comprehensive boilerplate template for building professional software projects with CLI Coding Agents (Antigravity and Antigravity). It provides a complete development environment with AI-powered agent orchestration, automated workflows, and intelligent project management.
...
├── .cursorrules           # Project-specific Claude instructions
...
**Antigravity Agents** (`.agent/skills/`):
- `planner.md` - Technical planning and architecture (Claude Opus 4.6 Thinking)
...
- `docs-manager.md` - Documentation management (Gemini 3 Pro High)
...
3. **skill-init.cjs** - Skill Context Injection
   - Injects compact context (~200 tokens) when spawning parallel tasks
...
- **.cursorrules**: Development instructions and workflows
...
- **.agent/rules/**: Development rules and protocols
...
Script: `.agent/hooks/send-discord.sh`
...
### Workflows
- `.agent/rules/primary-workflow.md`
- `.agent/rules/development-rules.md`
- `.agent/rules/orchestration-protocol.md`
- `.agent/rules/documentation-management.md`

## Related Projects

- **antigravity-kit** - Antigravity Kit website (`../antigravity-kit`)
- **antigravity-kit-marketing** - Marketing Kit (`../antigravity-kit-marketing`)
- **antigravity-kit-cli** - CLI setup tool (`../antigravity-kit-cli`)
- **antigravity-kit-docs** - Public docs (`../antigravity-kit-docs`)
...
**License**: MIT
**Author**: Duy Nguyen
**Repository**: https://github.com/antigravity-kit/antigravity-kit
