...
Antigravity Kit is a comprehensive boilerplate template that revolutionizes software development by integrating AI-powered CLI coding agents (Antigravity and Antigravity) into the development workflow. It provides a complete orchestration framework where specialized AI agents collaborate to handle planning, implementation, testing, code review, documentation, and project management.
...
**Command Organization** (`.agent/workflows/`):
...
**Organized by Domain** (`.agent/skills/`):
...
- Depends on Antigravity AI agent
...
### External Resources
- [Antigravity Documentation](https://docs.claude.com/en/docs/claude-code/overview)
...
### Support & Community
- GitHub Issues: https://github.com/antigravity-kit/antigravity-kit/issues
- Discussions: https://github.com/antigravity-kit/antigravity-kit/discussions
- Repository: https://github.com/antigravity-kit/antigravity-kit
